...
/**
 * This class implements and iterator over a compressed incremental list of <code>long</code>s which removes all
...
class IncrementalListUniqueIterator extends BaseListIterator {
    ...
    /**
     * Creates an unique iterator over the compressed representation of an incremental list of <code>long</code>s.
