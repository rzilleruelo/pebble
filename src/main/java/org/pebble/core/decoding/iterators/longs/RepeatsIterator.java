 ...
 * {@link org.pebble.core.encoding.OutputSuccinctStream#writeRepetitions(it.unimi.dsi.fastutil.longs.LongList) writeRepetitions}
...
class RepeatsIterator extends CompressionIterator {
    ...
    public long next() throws IOException {
        if (currentIndex == currentValue && repetitions > 0) {
            ...
            seek();
            currentValue = inputBitStream.readDelta() + currentValue + 1L;
            repetitions = inputBitStream.readDelta() + 1;
            remainingElements--;
            recordOffset();
        }
