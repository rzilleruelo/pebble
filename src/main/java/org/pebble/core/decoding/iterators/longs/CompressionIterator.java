...
abstract class CompressionIterator {
     ...
     * @throws java.io.IOException when there is an exception reading from <code>inputBitStream</code> the number of
     ...
     * @throws java.io.IOException when there is an exception moving the cursor of <code>inputBitStream</code>.
     */
     ...
     * @throws java.io.IOException when there is an exception reading the next value from <code>inputBitStream</code>.
     */
