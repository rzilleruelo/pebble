...
public class OutputSuccinctStream extends OutputBitStream {
     ...
     * <ul>
     *     <li>
     *         Retrieves from <code>intReferenceListsStore</code> the list that produces the smaller encoding for
     *         <code>list</code>.
     *     </li>
     *     <li>
     *         Adds <code>list</code> to <code>intReferenceListsStore</code> so it can be use as a reference by
     *         future lists.
     *     </li>
     *     <li>
     ...
     * , <code>listLindex</code> 63, <code>intReferenceListsStore</code> containing the reference list
