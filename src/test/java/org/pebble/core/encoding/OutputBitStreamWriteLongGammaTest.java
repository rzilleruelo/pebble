...
public class OutputBitStreamWriteLongGammaTest {
    ...
    public void ItShouldGenerateExpectedOutput() throws IOException {
         ...
         * 000010010 Gamma Encoding.
         */
        final String expectedOutput = "000010010";

        final int writtenBits = outputBitStream.writeGamma(x);
