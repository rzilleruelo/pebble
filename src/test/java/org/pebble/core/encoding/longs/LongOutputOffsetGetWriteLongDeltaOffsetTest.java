...
public class LongOutputOffsetGetWriteLongDeltaOffsetTest {

    @Test
    public void whenOffsetIsPreCalculatedItShouldReturnExpectedOffsetSuccessfully() {
        final long value = 4094L;
        /**
        ...
        final int offset = LongOutputOffset.getWriteDeltaOffset(value);
